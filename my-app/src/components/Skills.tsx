...
const skillGroups = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'C# / ASP.NET / .NET Core', level: 80 },
      { name: 'REST APIs', level: 95 },
      { name: 'SOAP / WCF', level: 70 },
    ],
  },
  {
    label: 'Databases',
  ...
  },
  {
    ...
    skills: [
      { name: 'Git', level: 92 },
      { name: 'Jenkins / Argo CI/CD', level: 80 },
  ...
  return (
    <div style={{ marginBottom: '18px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
        <span style={{ color: '#e2e8f0', fontSize: '0.95rem', fontFamily: "'Rajdhani', sans-serif", fontWeight: 600 }}>{name}</span>
      ...
      <div className="container">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '32px' }}>
          {skillGroups.map((group) => (
            ...
            onMouseEnter={e => {
              ...
              (e.currentTarget as HTMLElement).style.boxShadow = `0 0 25px ${group.color}15`;
            }}
            onMouseLeave={e => {
              ...
              <h3 style={{
                ...
                color: group.color, marginBottom: '24px',
        ...
        <div style={{ marginTop: '60px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', justifyContent: 'center' }}>
            {['jQuery', 'Google APIs', 'PHP', 'NgRx', 'Zeplin', 'Scrum', 'Agile', 'Accessibility', 'SOAP'].map(t => (
              <span key={t} style={{
